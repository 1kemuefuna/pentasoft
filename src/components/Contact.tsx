...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 md:py-[120px] relative">
      <div className="absolute top-0 left-0 -z-[1] w-full h-1/2 bg-[#f3f4fe] dark:bg-dark-bg"></div>
      <div className="container m-auto px-4">
        <div className="flex flex-wrap mx-[-16px]">
          <div className="w-full px-4">
            <div className="max-w-[570px] mb-12 lg:mb-0 mx-auto text-center">
              ...
              <p className="text-base text-body-color dark:text-white dark:opacity-90 leading-relaxed mb-9">
